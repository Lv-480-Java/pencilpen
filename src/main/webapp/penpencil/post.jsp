...
<%
    ...
    <div class="comment-wrapper">
      <div class="comment">
        <div class="comment-username"><p><%=comment.getNickname()%></p></div>
        <div class="comment-text"><p><%=comment.getCommentText()%></p></div>
      </div>
      </div>
